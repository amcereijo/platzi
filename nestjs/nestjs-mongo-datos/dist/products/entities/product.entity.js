...
const sub_doc_entity_1 = require("./sub-doc.entity");
let Product = class Product extends mongoose_2.Document {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, description: { required: true, type: () => String }, price: { required: true, type: () => Number }, stock: { required: true, type: () => Number }, image: { required: true, type: () => String }, category: { required: true, type: () => Object }, brand: { required: true, type: () => Object }, subDoc: { required: true, type: () => require("./sub-doc.entity").SubDoc }, subDocs: { required: true, type: () => [require("./sub-doc.entity").SubDoc] } };
    }
};
__decorate([
...
__decorate([
    mongoose_1.Prop({ type: sub_doc_entity_1.SubDocSchema }),
    __metadata("design:type", sub_doc_entity_1.SubDoc)
], Product.prototype, "subDoc", void 0);
__decorate([
    mongoose_1.Prop({ type: [sub_doc_entity_1.SubDocSchema] }),
    __metadata("design:type", mongoose_2.Types.Array)
], Product.prototype, "subDocs", void 0);
Product = __decorate([
    mongoose_1.Schema()
], Product);
